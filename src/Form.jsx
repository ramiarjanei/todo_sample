...
class Form extends Component {
  constructor() {
    ...
    this.handleNotStartedChange= this.handleNotStartedChange.bind(this);
  ...
  handleNotStartedChange(evt){
    this.props.onChange({
      NotStarted: evt.target.checked,
    });
  }
      ...
      >
        ...
        >
          ...
          <input
            ...
            name="NotStarted"
            type="checkbox"
            checked={task.NotStarted}
            onChange={this.handleNotStartedChange}
          />
        </label>
        <input
